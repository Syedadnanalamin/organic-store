...
router.post('/', async (req, res) => {
  ...
  // Await the Conversions API call to ensure it runs before Vercel freezes execution context
  try {
    await sendCapiEvent({
    ...
    console.error(`[FB CAPI Proxy] CAPI tracking error for "${event_name}":`, err);
  }
